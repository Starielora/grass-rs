...
impl Grid {
    pub fn new(
        ...
        let mut vs_spv_file =
            std::fs::File::open("target/debug/build/grass-rs-0ac09294362a3e2a/out/grid.vert.spv")?;
        ...
        let mut fs_spv_file =
            std::fs::File::open("target/debug/build/grass-rs-0ac09294362a3e2a/out/grid.frag.spv")?;
